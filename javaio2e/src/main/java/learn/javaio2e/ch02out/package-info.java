/**
 * 2-1, AsciiChart, is a simple program that writes the printable ASCII characters (32 to 126) on the console.<br>
 * 2-2, AsciiArray is a simple program that constructs a byte array filled with an ASCII chart,
