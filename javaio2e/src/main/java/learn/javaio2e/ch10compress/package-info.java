/**
 * 10-1. DirectDeflater - deflates files named on the command line.<br>
 * 10-2. DirectInflater - inflates files named on the command line.<br>
 * 10-3. FileDeflater - deflates files using DeflaterOutputStream.<br>
 * 10-4. FileInflater - inflates files using InflaterInputStream.<br>
 * 10-5. GZipper - reads a list of files from the command line and gzips each one.<br>
