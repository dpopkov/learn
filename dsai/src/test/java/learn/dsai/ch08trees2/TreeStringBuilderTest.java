...
public class TreeStringBuilderTest {
    ...
    public void testBuildingNotFullTree() {
        ...
        tree.insert(10);
        tree.insert(60);
        TreeStringBuilder<Integer> builder = new TreeStringBuilder<>(root, 2);
        String expected = ".............." + NL
                + "      40" + NL
                + "  20      60" + NL
                + "10  --  --  --" + NL
    ...
    public void testBuilding3CellWidth() {
        ...
        BSTree<Integer> tree = new BSTree<>(root);
        tree.insert(20);
        TreeStringBuilder<Integer> builder = new TreeStringBuilder<>(root, 3);
        String expected = "........." + NL
                + "    40" + NL
                + " 20   ---" + NL
                + "........." + NL;
    ...
    public void whenGetHeightThenReturnsHeight() {
        ...
        TreeStringBuilder<Integer> builder = new TreeStringBuilder<>(tree.getRoot(), 2);
